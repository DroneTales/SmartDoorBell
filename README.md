...
Если вы не используете видеокамеры в связке с HomeBridge, то найдите и закомvентируйте строку  
...
По-умолчанию дверной звонок включает два переключателя: Звук и Уведомления. Первый управляет звуком дверного звонка, второй - уведомлениями Apple Home. Вы можете оставить только один переключатель. Для этого закомvентируйте строку  
